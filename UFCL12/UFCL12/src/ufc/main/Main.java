...
public class Main {
		public static void main(String[] args) {
			...
			try{ // ამოწმებს მართკუთხედს
				...
				} // Validate რადგანაც არ აბრუნებს არაფერს და უბრალოდ ისვრის ექსეფშენებს, catch-ის გარეშე ვერ ვამოწმებ გაიარა თუ არა ვალიდაცია, შესაბამისად Finally ნებისმიერ შემთხვევაში დაუბეჭდავს ამ ტექსტს, ამიტომ გამოვიყენე validate() მეთოდის გადატვირთვა.
                                  // ამ კონკრეტულ შემთხვევაში მართკუთხედის გვერდი უარყოფითია და შესაბამისად სწორად შესრულდება პირობა.
