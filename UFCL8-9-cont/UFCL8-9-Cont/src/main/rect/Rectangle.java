...
public class Rectangle extends Figure implements Comparable {
	...
	@Override
	public int hashCode() {
		// ჰეშკოდში ორივე ინტეჯერი გადამყავს სტრინგში და ვაქცევ ერთ მთლიან დიდ რიცხვად, რომელიც ინტეჯერში შეიძლება არც ჩაეტიოს. ვიღებ უნიკალურ რიცხვს, რომელიც წერია სტრინგში და ვაბრუნებ ამ სტრინგის ჰეშკოდს.
